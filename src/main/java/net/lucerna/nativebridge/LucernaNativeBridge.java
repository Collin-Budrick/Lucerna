...
public final class LucernaNativeBridge {
    ...
    private void logDenoiseExecutionStatus() {
        ...
        Lucerna.LOGGER.info(
                ...
                denoise.rawGiInputReady(),
                denoise.cpuDenoisedReadbackReady(),
