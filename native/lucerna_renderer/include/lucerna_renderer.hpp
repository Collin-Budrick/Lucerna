...
struct NativeVirtualChunkGeometryTelemetry {
    ...
    std::uint64_t frustum_culling_candidate_count = 0;
    std::uint64_t occlusion_culling_candidate_count = 0;
    std::uint64_t occlusion_culling_placeholder_count = 0;
    std::uint64_t indirect_draw_candidate_count = 0;
    ...
    bool gpu_occlusion_culling_ready = false;
    bool indirect_draw_ready = false;
    std::string cluster_marker;
    std::string culling_marker;
    std::string culling_mode;
    std::string culling_reason;
    std::string gpu_culling_prerequisite_marker;
    std::string gpu_culling_blocker_reason;
    std::string frustum_culling_marker;
    std::string occlusion_culling_marker;
    std::string indirect_draw_marker;
...
struct NativeRound6DispatchExecutionTelemetry {
    ...
    std::uint64_t last_cpu_ray_traversal_sample_count = 0;
    std::uint64_t last_cpu_ray_traversal_hit_count = 0;
    std::uint64_t last_cpu_ray_traversal_miss_count = 0;
    std::uint64_t last_cpu_ray_traversal_shadow_candidate_count = 0;
    std::uint64_t last_cpu_ray_traversal_occlusion_candidate_count = 0;
    std::uint64_t last_cpu_ray_traversal_emissive_source_count = 0;
    std::uint64_t last_cpu_ray_traversal_surface_receiver_count = 0;
    ...
    std::uint64_t last_contact_shadow_occluded_sample_count = 0;
    std::uint64_t last_contact_shadow_checksum = 0;
    std::uint64_t last_cpu_output_checksum = 0;
    std::uint64_t last_physical_output_checksum = 0;
    std::uint64_t last_colored_bounce_checksum = 0;
    ...
    float last_colored_bounce_source_red = 0.0F;
    float last_colored_bounce_source_green = 0.0F;
    float last_colored_bounce_source_blue = 0.0F;
    float last_colored_bounce_mean_red = 0.0F;
    ...
    float last_contact_shadow_mean_darkening = 0.0F;
    float last_contact_shadow_max_darkening = 0.0F;
    ...
    bool last_cpu_ray_traversal_used_uploaded_surfaces = false;
    bool last_cpu_ray_traversal_used_uploaded_emissives = false;
    ...
    bool last_contact_shadow_recorded = false;
...
struct NativeDenoiseExecutionTelemetry {
    ...
    std::uint64_t last_cpu_readback_candidate_payload_bytes = 0;
    std::uint64_t last_cpu_readback_candidate_payload_checksum = 0;
    std::uint64_t last_shader_denoise_output_attempt_generation = 0;
    std::uint64_t last_public_mojang_shader_visual_output_generation = 0;
    ...
    bool last_cpu_readback_candidate_payload_ready = false;
    bool last_cpu_readback_candidate_payload_cpu_staged = false;
    bool last_cpu_readback_candidate_payload_non_gpu = true;
    bool last_public_mojang_shader_visual_output_attempted = false;
    bool last_public_mojang_shader_visual_output_submitted = false;
    bool last_public_mojang_shader_visual_output_ready = false;
    bool last_public_mojang_shader_visual_output_java_proof_required = true;
    bool last_real_shader_generated_visual_output_ready = false;
    bool last_real_shader_generated_visual_output_native_claim = false;
