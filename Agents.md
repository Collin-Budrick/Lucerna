...
Current controller estimate: **about 99.7% complete against this file**.
...
- Particle/translucency-specific visual proof remains open.
...
~~Screenshots prove raw vs denoised vs final image for the selected Round 7 CPU-output path.~~ **DONE/VALIDATED in `run/validation-logs/round7-denoise-composite-assert-20260619-172730.json`**
...
Particle/translucency-specific proof, real shader denoise quality, and temporal/flicker proof remain open.
