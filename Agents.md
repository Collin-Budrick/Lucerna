...
Current controller estimate: **about 99.86% complete against this file**.
...
- Real denoise shader output/image generation, stronger edge-preservation proof beyond the current guided visual path, and longer temporal flicker/noise comparison remain open.
...
Real shader denoise output/image generation, stronger temporal/flicker proof, and physically correct GI remain open.
