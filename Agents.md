...
Current controller estimate: **about 99.89% complete against this file**.
...
- **Agent N: First GI** **PARTIAL**
  ...
  - Pending/unvalidated: six-agent physical GI/tracing evidence round should surface physical GI sample counts, scene/source coupling, material/geometry coupling, bounce-source identity, and tracing-evidence markers in debug/status paths. Do not treat these markers as proof of physically correct GI until controller screenshots and logs validate them.
