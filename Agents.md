...
Current controller estimate: **about 99.85% complete against this file**.
...
- Real denoise shader/output, stronger edge-preservation proof beyond the current guided visual path, and longer temporal flicker/noise comparison remain open.
...
Real shader denoise output, stronger temporal/flicker proof, and physically correct GI remain open.
